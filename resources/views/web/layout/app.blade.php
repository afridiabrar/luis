        ...
        <div class="haeader-bottom-area">
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="logo-area"> <a href="{{ route('index') }}"><img style="max-width: 80%!important;" src="{{ asset('public/assets/maverick.jpg')}}" alt=""></a> </div>
              </div>
            ...
            <div class="off-canvas-inner"> 
              ...
              <div class="offcanvas-widget-area">
                <div class="off-canvas-contact-widget">
                  <ul>
                    <li> <a href="#"><i class="ionicons ion-ios-email-outline"></i> info@email.com</a> </li>
                  </ul>
                </div>
        ...
        <div class="col-lg-2 col-md-2">
          <div class="widget-footer mt-30">
            ...
            <li><a href="{{ route('index') }}"><i class="ion-android-arrow-dropright"></i>Home</a></li>
              ...
              <li><a href="{{ route('about_us') }}"><i class="ion-android-arrow-dropright"></i>About Us</a></li>
        ...
        <div class="col-lg-3 col-md-3">
          <div class="widget-footer mt-30">
            ...
            <ul class="footer-contact">
              <li><i class="ion-android-pin"></i> Abcd Street, AR 72469, UK</li>
              <li><i class="ion-android-call"></i> + 4444 4444 4444</li>
              <li><a href="#"><i class="ionicons ion-ios-email-outline"></i> info@email.com</a></li>
            </ul>
